...
<form action="includes/signup.inc.php" method="POST" onsubmit="return app_form_validator(this)" name="app_form" id="app_form">
...
<table width="760" cellspacing="0" cellpadding="0" border="0" align="center">
	...
	<tr>
					...
					<table class="#FF0000 " cellspacing="0" cellpadding="8" bordercolor="White" border="1">
						<tbody><tr>
						  ...
						  <td width="200"align="middle" valign="middle"><a href="application.html" class="link-home"><font color='white'>Registration Form</font></a></td>
						  <td width="200"align="middle" valign="middle"><a href="doc/sample.pdf" class="link-home"><font color='white'>User Manual</font></a></td>
  ...
  <tr>
    <td valign="top" bgcolor="#E3E3E3" align="left">
      <table class="black12" width="100%" cellspacing="0" cellpadding="5" border="0">
		...
		<tr>
          ...
          <td valign="middle" bgcolor="#E3E3E3" align="left"><input name="nameoforganization" class="textfield03" id="nameoforganization" onkeypress="return alpha(event,letters)" onblur="javascript:{this.value = this.value.toUpperCase(); }" type="text"></td>
        </tr>
        <tr>
          <td class="black12" valign="middle" bgcolor="#E3E3E3" align="left">Department<span class="red12">*</span></td>
          <td class="black12" valign="middle" bgcolor="#E3E3E3" align="center">:</td>
          <td valign="middle" bgcolor="#E3E3E3" align="left"><input name="department" class="textfield03" id="department" onkeypress="return alpha(event,letters)" onblur="javascript:{this.value = this.value.toUpperCase(); }" type="text"></td>
        </tr>
        <tr>
          <td class="black12" valign="middle" bgcolor="#E3E3E3" align="left">Name of Ministry<span class="red12">*</span></td>
          <td class="black12" valign="middle" bgcolor="#E3E3E3" align="center">:</td>
          <td valign="middle" bgcolor="#E3E3E3" align="left"><input name="nameofministry" class="textfield03" id="nameofministry" onkeypress="return alpha(event,letters)" onblur="javascript:{this.value = this.value.toUpperCase(); }" type="text"></td>
        </tr>
	...
	<tr bgcolor="#A2A2A2">
          ...
          <td class="black12" valign="middle" bgcolor="#E3E3E3" align="center">:</td>
          <td valign="middle" bgcolor="#E3E3E3" align="left"><input name="nameofcontactperson" class="textfield03" id="nameofcontactperson" onkeypress="return alpha(event,letters)" onblur="javascript:{this.value = this.value.toUpperCase(); }" type="text"></td>
        </tr>
        <tr>
          <td class="black12" valign="middle" bgcolor="#E3E3E3" align="left">Designation of Contact Person<span class="red12">*</span></td>
          <td class="black12" valign="middle" bgcolor="#E3E3E3" align="center">:</td>
          <td valign="middle" bgcolor="#E3E3E3" align="left"><input name="designationofcontactperson" class="textfield03" id="designationofcontactperson" onkeypress="return alpha(event,letters)" onblur="javascript:{this.value = this.value.toUpperCase(); }" type="text"></td>
        </tr>
        <tr>
			<td width="3%" valign="middle" align="left">&nbsp;</td>
	<tr bgcolor="#A2A2A2">
        ...
        <tr>
          ...
          <td valign="middle" height="30" bgcolor="#E3E3E3" align="left"><table class="black12" width="100%" cellspacing="0" cellpadding="0" border="0">
            <tbody><tr>
              <td width="26%" valign="middle" height="23" align="left"><input name="mobileno" class="textfield02" id="mobileno" maxlength="11" onkeypress="return alpha(event,numbers)" type="text"></td>
        ...
        <tr>
          ...
          <td valign="middle" height="30" bgcolor="#E3E3E3" align="left"><table class="black12" width="100%" cellspacing="0" cellpadding="0" border="0">
            <tbody><tr>
              <td width="26%" valign="middle" height="23" align="left"><input name="confirmmobile" class="textfield02" id="confirmmobile" maxlength="11" onkeypress="return alpha(event,numbers)" type="text"></td>
          ...
          <td valign="middle" height="30" bgcolor="#E3E3E3" align="left"><table class="black12" width="100%" cellspacing="0" cellpadding="0" border="0">
            <tbody><tr>
              <td width="26%" valign="middle" height="23" align="left"><input name="Email" class="textfield02" id="Email" type="text"></td>
	...
	<tr bgcolor="#A2A2A2">
        ...
        <tr>
          ...
          <td valign="middle" height="30" bgcolor="#E3E3E3" align="left"><table class="black12" width="100%" cellspacing="0" cellpadding="0" border="0">
            <tbody><tr>
              <td width="26%" valign="middle" height="23" align="left"><input name="applicationstartdate" class="textfield02" id="applicationstartdate" maxlength="11" onkeypress="return alpha(event,numbers)" type="text"></td>
        ...
        <tr>
          ...
          <td valign="middle" height="30" bgcolor="#E3E3E3" align="left"><table class="black12" width="100%" cellspacing="0" cellpadding="0" border="0">
            <tbody><tr>
              <td width="26%" valign="middle" height="23" align="left"><input name="applicationenddate" class="textfield02" id="applicationenddate" maxlength="11" onkeypress="return alpha(event,numbers)" type="text"></td>
          ...
          <td valign="middle" height="30" bgcolor="#E3E3E3" align="left"><table class="black12" width="100%" cellspacing="0" cellpadding="0" border="0">
            <tbody><tr>
              <td width="26%" valign="middle" height="23" align="left"><input name="agelimit" class="textfield02" id="agelimit" type="text"></td>
          ...
          <td valign="middle" height="30" bgcolor="#E3E3E3" align="left"><table class="black12" width="100%" cellspacing="0" cellpadding="0" border="0">
            <tbody><tr>
              <td width="26%" valign="middle" height="23" align="left"><input name="postno" class="textfield02" id="postno." type="text"></td>
        ...
        <tr>
          <td colspan="3" class="black11" valign="middle" bgcolor="#A2A2A2" align="center">
            <input name="info_yes" id="info_yes" onclick="agreesubmit(this)" type="checkbox">
            The above information is correct and I would like to submit.</td>
        </tr>
		<tr>
          <td colspan="3" valign="middle" bgcolor="#A2A2A2" align="center">
            <input name="button" id="button" value="   Submit   " type="submit"></td>
        </tr>
